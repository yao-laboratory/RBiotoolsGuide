...
1.  Download **Rtools45** (or the latest version compatible with your R version) from [CRAN Rtools](https://cran.r-project.org/bin/windows/Rtools/rtools42/rtools.html).

::: {.callout-important}

R Version Compatibility
For R 4.5.0 and later, you must install Rtools45. Using an older version of Rtools will prevent RBiotools from compiling correctly.
:::
...
Once you extract the folder, verify that you see both the getting-started.R script and the RBiotools_0.5.7.tar.gz file. You will need both later!
:::
