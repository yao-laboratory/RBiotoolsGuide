...
![Downloading the repository as a ZIP file](downloadzip.png)
...
![](downloadGenBank(proteobacteria).png)
...
![](dendrogram16S(eColi).png)

![](dendrogram16S_eColi_plot.png)
...
![](dendrogram16S(proteobacteria).png)

![](dendrogram16S_proteobacteria_plot.png)
...
![Opening an SVG using a web browser](genome-atlas-reference-image.png)
...
![Opening the heat codon result from within RStudio.](heat-codon-reference-image.png)
